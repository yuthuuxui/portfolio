  ...
  $(function () {
    ...
    var circle = new ProgressBar.Circle('#circle-progress-1', {
      ...
      text: {
        ...
        value: '<p class="circle-progress-value">25</p><p class="circle-progress-label">Today attendings</p>'
      }
    });
    ...
    var circle2 = new ProgressBar.Circle('#circle-progress-2', {
      ...
      text: {
        autoStyleContainer: false,
        value: '<p class="circle-progress-value">12</p><p class="circle-progress-label">Attended</p>'
      }
    });
      ...
      new Chart(doughnutChartCanvas, {
        ...
        data: {
          ...
          datasets: [{
              ...
              borderColor: ['#38ce3c','#ffca00','#ff4d6b']
          }]
        },
        options: {
          cutout: 75,
